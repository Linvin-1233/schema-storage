const API_URL = "https://myshema.weizhihan3.workers.dev/contents/contents/schematic";
    ...
    for (const item of data) {
        if (item.type === "dir") {
            ...
            files.push({
                name: item.name,
                path: fullPath,
                url: `https://myshema.weizhihan3.workers.dev/raw/${encodeURIComponent(fullPath)}` // ✅ 关键：raw 路径用于下载
            });
        }
    }
}
